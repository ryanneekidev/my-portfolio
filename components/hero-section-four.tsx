                    ...
                    <div className="py-20 md:py-36">
                        <div className="relative z-10 mx-auto max-w-5xl px-6">
                            <div className="relative text-center">
                                <h1 className="mx-auto max-w-2xl text-balance text-4xl font-bold md:text-5xl">Transforming Ideas into Dynamic Web Applications</h1>

                                <p className="text-muted-foreground mx-auto my-6 max-w-2xl text-balance text-xl">Hello, I'm Rayan Mamhoud. Dedicated to continuous learning and innovation in all fields of tech.</p>
